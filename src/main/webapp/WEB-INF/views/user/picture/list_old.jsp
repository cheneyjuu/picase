...
<body>
        ...
        <ul id="myGallery">
            ...
            <li class="imagelist">
                <img data-frame="${ctx}${picture.imagePath}${picture.thumbName}" src="${ctx}${picture.imagePath}${picture.sliderName}"/>
            </li>
                </c:forEach>
        </ul>
        <div class="modal" id="myModal" style="display: none; width: 100%; height: 100%; background-color: #000;top: 0;left: 19%;">
            <button type="button" style="" class="close" data-dismiss="modal">Ｘ</button>
        </div>
